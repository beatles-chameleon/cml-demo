...
function addApiPrefix(url, domainkey) {
  ...
  if (domainMap) {
    ...
    // 老版本配置apiPrefix
    if (true) {
      return "http://172.24.40.105:5556" + url;
    }
  }
}
...
function request(_ref) {
  ...
  if (domain) {
    ...
    if (apiPrefix) {
      // 有apiPrefix优先
      if (true) {
        url = "http://172.24.40.105:5556" + url;
      }
    }
  }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__("../../../chameleon-open/chameleon/packages/chameleon-miniapp-target/node_modules/webpack/buildin/global.js")))
