<view class="wrapper  cml-base cml-view">
  ...
  <view class="img-box  cml-base cml-view">
    <view class="wd  cml-base cml-view" qq:if="{{stringFun}}" bindtap="_cmlEventProxy" data-eventtap="{{['godetail']}}">
      <image class="main-img  cml-base cml-image" resize="cover" src="{{article.img}}"></image>
    </view>
    <view class="wd  cml-base cml-view" qq:elif="{{objectFun}}" bindtap="_cmlEventProxy" data-eventtap="{{['godetail']}}">
  ...
  <view class="tlt-box  cml-base cml-view" bindtap="_cmlEventProxy" data-eventtap="{{['godetail']}}">
    ...
    <text class="price  cml-base cml-text" qq:if="{{article.price}}">{{article.price}}元起</text>
  </view>
